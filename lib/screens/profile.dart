...
import 'package:info_hub_project/profile/activities.dart';
import 'package:info_hub_project/profile/myfriends.dart';
import 'package:info_hub_project/profile/myprofile.dart';
import 'package:info_hub_project/profile/travels.dart';
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: 3 == selectedItem ? Colors.blue : Colors.grey[300],
                    ),
                    child: Center(
                      child: Icon(
                        Iconsax.clock,
          ...
          Expanded(
            child: Container(
              ...
              child: PageView(
                ...
                children: [
                  //four other pages rendered here
                  MyProfile(),
                  MyFriends(),
                  Activity(),
                  Travels(),
